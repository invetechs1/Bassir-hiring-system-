...
<head>
    ...
    <title>Access Denied · Bassir AI Recruitment</title>
    <style>
...
<body>
    <main class="panel">
        ...
        <p class="muted">You do not have permission to access this area. Contact your HR system administrator if this access is required.</p>
